...
public class ProfilPresenterTest {
    ...
    @Test
    public void shouldShowErrorMessageWhenFirstNameIsEmpty() throws
            Exception {
    ...
    @Test
    public void shouldShowErrorMessageWhenLastNameIsEmpty() throws
            Exception {
    ...
    @Test
    public void shouldShowErrorMessageWhenSemesterIsEmpty() throws
            Exception {
    ...
    @Test
    public void shouldShowErrorMessageWhenSemesterIsNotNumber() throws
            Exception {
    ...
    @Test
    public void
    shouldShowErrorMessageWhenSemesterIsNumberButNotInRange() throws
            Exception {
    ...
    @Test
    public void
    shouldShowErrorMessageWhenSemesterIsNumberButNotInRange2() throws
            Exception {
    ...
    @Test
    public void shouldShowErrorMessageWhenTanggalLahirIsEmpty() throws
            Exception {
    ...
    @Test
    public void shouldShowErrorMessageWhenTanggalLahirIsLess6() throws
            Exception {
    ...
    @Test
    public void shouldShowErrorMessageWhenTanggalLahirIsMore6() throws
            Exception {
